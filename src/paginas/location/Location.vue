<template>
  <div>
    <v-app-bar color="primary" dense dark>
      ...
      <v-btn icon @click.stop="accessModule()" title="Click to reload page"><df-icon icon="reload" size="lg" /></v-btn>
      <v-btn icon @click.stop="toggleFilterField()" title="Click to search"><df-icon icon="search" size="lg" /></v-btn>
      <v-btn icon @click.stop="accessRegistration()" title="Click to register a new location"><df-icon icon="plus" /></v-btn>
    </v-app-bar>
